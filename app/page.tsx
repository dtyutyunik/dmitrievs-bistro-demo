...
import { BASE_PATH, DOORDASH, GRUBHUB, HERO, PHONE, SEAMLESS } from "./site-data";
...
export default function Home() { return <main><SiteHeader active="home"/>
  <section className="official-hero" style={{backgroundImage:`linear-gradient(90deg,rgba(26,12,7,.28),rgba(26,12,7,.04)),url('${HERO}')`}}><div><p>WELCOME to Dmitriev&apos;s Bistro, where traditional family recipes meet warm hospitality</p><h1>Dmitriev&apos;s<br/>Bistro</h1><div className="hero-actions"><a href={`${BASE_PATH}/our-menu/`}>Our Menu</a><a href={PHONE}><Phone size={18}/> Call</a></div><div className="delivery-cta" aria-label="Order online"><div className="delivery-buttons"><a className="doordash" href={DOORDASH} target="_blank" rel="noreferrer">DoorDash</a><a className="grubhub" href={GRUBHUB} target="_blank" rel="noreferrer">Grubhub</a><a className="seamless" href={SEAMLESS} target="_blank" rel="noreferrer">Seamless</a></div></div></div></section>
